...
export default function Home() {
  ...
  return (
    <Main>
      <Title>Calories Calculate</Title>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          <Input type='number' placeholder='protein' {...register('b1')} />
          <Input type='number' placeholder='Carbs' {...register('b2')} />
          <Input type='number' placeholder='Fat' {...register('b3')} />
          <Input type='number' placeholder='Total Calories' {...register('b4')} />
        </div>
        <div>
          <Input type='number' placeholder='protein' {...register('c1')} />
          <Input type='number' placeholder='Carbs' {...register('c2')} />
          <Input type='number' placeholder='Fat' {...register('c3')} />
          <Input type='number' placeholder='Total Calories' {...register('c4')} />
        </div>
        <div style={{ marginTop: '1rem' }}>
          <SubmitButton type='submit'>Calculate</SubmitButton>
        </div>
      </Form>
      {stepData?.length != 0 && <StepSolution data={stepData} />}
      {/* <Form onSubmit={handleFoodCal(onSubmit2)} style={{ marginTop: '2rem' }}>
        <MatrixTitle>Food Calculate</MatrixTitle>
        <div>
          <Input type='number' placeholder='protein' {...register2('e1')} />
          <Input type='number' placeholder='Carbs' {...register2('e2')} />
          <Input type='number' placeholder='Fat' {...register2('e3')} />
        </div>
        <div style={{ marginTop: '1rem' }}>
          <SubmitButton type='submit'>Calculate</SubmitButton>
        </div>
